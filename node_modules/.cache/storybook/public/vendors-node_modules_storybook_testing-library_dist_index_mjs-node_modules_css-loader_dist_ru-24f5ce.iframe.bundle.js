(self["webpackChunkproduction_project"] = self["webpackChunkproduction_project"] || []).push([["vendors-node_modules_storybook_testing-library_dist_index_mjs-node_modules_css-loader_dist_ru-24f5ce"],{
...
testingLibrary.screen = Object.entries(testingLibrary.screen).reduce(
  (acc, [key, val]) => Object.defineProperty(acc, key, {
    get() {
      return once.warn(ts_dedent__WEBPACK_IMPORTED_MODULE_2__["default"]`
...
/* harmony export */ });
/* harmony import */ var _utils_click_isClickableInput_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/click/isClickableInput.js */ "./node_modules/@testing-library/user-event/dist/esm/utils/click/isClickableInput.js");
/* harmony import */ var _utils_dataTransfer_DataTransfer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/dataTransfer/DataTransfer.js */ "./node_modules/@testing-library/user-event/dist/esm/utils/dataTransfer/DataTransfer.js");
...
async function paste(clipboardData) {
    ...
    const target = (_activeElement = doc.activeElement) !== null && _activeElement !== void 0 ? _activeElement : /* istanbul ignore next */ doc.body;
    var ref;
    const dataTransfer = (ref = typeof clipboardData === 'string' ? getClipboardDataFromString(doc, clipboardData) : clipboardData) !== null && ref !== void 0 ? ref : await (0,_utils_dataTransfer_Clipboard_js__WEBPACK_IMPORTED_MODULE_2__.readDataTransferFromClipboard)(doc).catch(()=>{
...
function getClipboardDataFromString(doc, text) {
    const dt = (0,_utils_dataTransfer_DataTransfer_js__WEBPACK_IMPORTED_MODULE_1__.createDataTransfer)((0,_utils_misc_getWindow_js__WEBPACK_IMPORTED_MODULE_5__.getWindow)(doc));
...
/* harmony import */ var _UI_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./UI.js */ "./node_modules/@testing-library/user-event/dist/esm/document/UI.js");
...
function copySelection(target) {
    const data = (0,_utils_focus_selection_js__WEBPACK_IMPORTED_MODULE_6__.hasOwnSelection)(target) ? {
        'text/plain': readSelectedValueFromInput(target)
    } : {
        'text/plain': String(target.ownerDocument.getSelection())
    };
    const dt = (0,_utils_dataTransfer_DataTransfer_js__WEBPACK_IMPORTED_MODULE_1__.createDataTransfer)((0,_utils_misc_getWindow_js__WEBPACK_IMPORTED_MODULE_5__.getWindow)(target));
...
function readSelectedValueFromInput(target) {
    const sel = (0,_UI_js__WEBPACK_IMPORTED_MODULE_10__.getUISelection)(target);
    const val = (0,_UI_js__WEBPACK_IMPORTED_MODULE_10__.getUIValue)(target);
...
/* harmony import */ var _Blob_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Blob.js */ "./node_modules/@testing-library/user-event/dist/esm/utils/dataTransfer/Blob.js");
/* harmony import */ var _DataTransfer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DataTransfer.js */ "./node_modules/@testing-library/user-event/dist/esm/utils/dataTransfer/DataTransfer.js");
    ...
    return Object.assign(new class Clipboard extends window.EventTarget {
        ...
        async readText() {
            ...
            for (const item of this.items){
                ...
                if (type) {
                    text += await item.getType(type).then((b)=>(0,_Blob_js__WEBPACK_IMPORTED_MODULE_2__.readBlobText)(b, window.FileReader));
                }
            }
            return text;
        }
...
async function readDataTransferFromClipboard(document) {
    ...
    const dt = (0,_DataTransfer_js__WEBPACK_IMPORTED_MODULE_1__.createDataTransfer)(window);
    for (const item of items){
        for (const type of item.types){
            dt.setData(type, await item.getType(type).then((b)=>(0,_Blob_js__WEBPACK_IMPORTED_MODULE_2__.readBlobText)(b, window.FileReader)));
        }
    }
    return dt;
}
async function writeDataTransferToClipboard(document, clipboardData) {
    ...
    for(let i = 0; i < clipboardData.items.length; i++){
        ...
        const blob = (0,_DataTransfer_js__WEBPACK_IMPORTED_MODULE_1__.getBlobFromDataTransferItem)(window, dtItem);
